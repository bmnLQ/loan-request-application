...
// http://172.23.0.1:3000/api/foo/bar -> http://www.example.org/api/foo/bar
```
...
var options = {
        ...
        router: {
            // when request.headers.host == 'dev.172.23.0.1:3000',
            // override target 'http://www.example.org' to 'http://localhost:8000'
            'dev.172.23.0.1:3000' : 'http://localhost:8000'
        }
    };
...
* **option.router**: object/function, re-target `option.target` for specific requests.
    ...
    router: {
        'integration.172.23.0.1:3000' : 'http://localhost:8001',  // host only
        'staging.172.23.0.1:3000'     : 'http://localhost:8002',  // host only
        '172.23.0.1:3000/api'         : 'http://localhost:8003',  // host + path
